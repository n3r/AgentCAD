...
SPECS measure the built solid: the section is 30 x 30, the bar is as long as
it was asked to be, and the centre bore is 6.8 mm (the tapping size for an
M8 end fastener, which is the whole reason it is there).
"""
