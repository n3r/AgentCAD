# 0311 — 2026-08-23 — PRD-027 slice 4: `bulk_part_op` as one undo step, `remove_parts`, the kernel-free dashboard
...
`make test` — see 0312 (slices 4 and 5 landed in one commit; the count is cited there).
