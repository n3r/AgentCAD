# 0309 — 2026-08-23 — PRD-027 slice 2: search engine, the `field:value` query language, `search_parts`, `GET …/search`
...
`make test` — see 0310 (slices 2 and 3 landed in one commit; the count is cited there).
