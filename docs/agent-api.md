...
|---|---|
| Exact B-rep | **STEP only** (and `.brep`). Everything else is a tessellation of it. |
...
| Tessellation + colors + metadata | **3MF, glTF/GLB, USD.** Structured STEP carries per-instance colors too; STL carries neither. |
