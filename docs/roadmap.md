...
|---|---|---|---|---|
| [001](prd/pending/PRD-001-branching-version-control.md) | Branching version control — branches, immutable versions, semantic merge with real conflicts, kernel-validated merge gates | pending | analysis | — |
