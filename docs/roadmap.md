...
| [004](prd/in-progress/PRD-004-geometry-ci.md) | Geometry CI — `agentcad check` + GitHub Action: rebuild, specs, interference, drawings on every ref/proposal | in progress (implemented; AC2–AC10 verified, AC1 awaits the live run) | analysis | 001 · 003 |
