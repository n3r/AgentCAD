...
| [005](prd/in-progress/PRD-005-multi-tenant-cloud.md) | Multi-tenant cloud — **the remainder after the 005a carve-out**: orgs, workspaces, per-project roles, audit principals, OIDC/passkeys, per-tenant fair scheduling, local-first git sync, signed desktop builds | in progress | analysis | 005a · 006 |
