...
| 5 | **006** — **built out of order (18 Aug 2026)** | Sandboxing becomes *blocking* only when third-party code runs on our servers — which is 031b, not 031a. It was built in parallel with steps 3 and 4 (PR #22), because 005a shipped with "an account is a shell" as its stated price and that price was cheaper to remove than to keep explaining. Windows AppContainer is carved out as 006b. |
