...
| [005a](prd/in-progress/PRD-005a-hosted-core.md) | Hosted core ("005-lite") — one deployable instance (Dockerfile + compose), invite-only identity (sessions for browsers, bearer tokens for agents), and an enumerated, kernel-free public-read surface | **implemented — step 2 of the marketplace chain**; AC1–AC11 verified except AC3's browser half, which is graded as evidence (no Chrome extension was available in any session — see PRD and changelog 0197) ([design](superpowers/specs/2026-08-17-hosted-core-design.md) · [plan](superpowers/plans/2026-08-17-hosted-core.md)) | founder decision (16 Aug 2026) | 011 · 008 |
