...
| [007](prd/in-progress/PRD-007-share-links-customizer.md) | Share links & customizer publishing — read-only viewer links; published parts with parameter sliders emitting B-rep artifacts | **implemented** (step 3, the growth loop) — on branch `prd-007-share-links-customizer`, AC1–AC9 verified, the two browser ACs graded as evidence | analysis + idea 1e | 005a (006 not required for our own content — see 005a's design, Decision 2) |
